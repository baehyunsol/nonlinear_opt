...
/// y = ax^2 + bx + c\
/// params = [a, b, c, _, _, _, _, _]
pub fn quad(params: [f64; 8], x: f64) -> f64 {
    params[0] * x * x + params[1] * x + params[2]
}

/// y = ax^7 + bx^6 + cx^5 + dx^4 + ex^3 + fx^2 + gx + h\
/// params: [a, b, c, d, e, f, g, h]
pub fn poly(params: [f64; 8], x: f64) -> f64 {
...
/// params: [a, b, c, d, e, f, g, _]
pub fn trigo(params: [f64; 8], x: f64) -> f64 {
...
pub fn linear(params: [f64; 8], x: [f64; 7]) -> f64 {
...
/// params: [a, b, c, d, e, f, g, _]
pub fn exp(params: [f64; 8], x: f64) -> f64 {
